				...
				@if( ! empty($subjects[$period->id]))
			  	<table class="table">
					...
					@endif
							...
							<td>
								{!! Form::select('teachers['.$subject->id.']', $teachers, isset($subjects_teachers[$subject->id]) ? $subjects_teachers[$subject->id] : null, ['class' => 'form-control subject-teacher', 'placeholder' => 'Please select...']) !!}
							</td>
					</tr>
					@endforeach
			    </table>
