    ...
    <table class="table table-hover">
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td class="table-title"><a href="/users/{{$student->id}}">{!! $student->getFullName() !!}</a></td>
    			<td><a href="/users/{{$student->id}}">{{ $student->email }}</a></td>
    			<td>{{$student->phone}}</td>
    			<td>{!! $student->status !!}</td>
    			<td>{!! $student->created_at !!}</td>
    			<td><a href="/login-as/{{$student->id}}">{!! trans('app.login_as') !!}</a></td>
    		</tr>
    		@endforeach
    	</tbody>
    </table>
